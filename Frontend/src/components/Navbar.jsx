...
function Navbar({
  ...
  return (
    <header className="relative z-40 border-b border-white/10 bg-slate-950/70 px-4 py-3 backdrop-blur">
          ...
          <div className="flex items-center justify-end gap-3 sm:justify-start">
            <div ref={notificationMenuRef} className="relative">
              ...
              {notificationMenuOpen && (
                <div
                  className="absolute right-0 z-[70] mt-2 w-[22.5rem] max-w-[calc(100vw-2rem)] overflow-hidden rounded-2xl border border-white/10 bg-slate-900/95 shadow-2xl shadow-slate-950/40 backdrop-blur max-sm:right-0 max-sm:w-[calc(100vw-24px)] max-sm:max-w-[20rem]"
                  role="menu"
                >
                  <div className="flex items-center justify-between gap-3 border-b border-white/10 px-4 py-3">
                    ...
                    <button
                      ...
                      className="shrink-0 text-xs font-medium text-sky-300 transition hover:text-sky-200 disabled:cursor-not-allowed disabled:text-slate-500"
                    >
                      {markAllNotificationsLoading
                        ? "Marking..."
                        : "Mark all as read"}
            ...
            <div ref={profileMenuRef} className="relative">
              <button
                ...
                className="flex max-w-full items-center gap-3 rounded-lg border border-white/10 bg-slate-900/80 px-3 py-2 text-left transition hover:bg-slate-800 sm:max-w-none"
              ...
              >
                ...
                <span className="min-w-0 max-w-[8.5rem] sm:max-w-[10rem]">
              ...
              {profileMenuOpen && (
                <div
                  className="absolute right-0 z-[70] mt-2 w-56 max-w-[calc(100vw-2rem)] overflow-hidden rounded-lg border border-white/10 bg-slate-900 py-2 shadow-2xl shadow-slate-950/40 max-sm:right-0 max-sm:w-[calc(100vw-24px)] max-sm:max-w-[20rem]"
                  role="menu"
                >
                  <Link
                    to="/profile"
